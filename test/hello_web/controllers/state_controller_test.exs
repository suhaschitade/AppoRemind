defmodule HelloWeb.StateControllerTest do
  use HelloWeb.ConnCase

  alias Hello.StateContext

  @create_attrs %{active: true, name: "some name", twolettercode: "some twolettercode"}
  ...
  def fixture(:state) do
    {:ok, state} = StateContext.create_state(@create_attrs)
    state
  end
