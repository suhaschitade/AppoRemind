defmodule Hello.StateContext do
  @moduledoc """
  The StateContext context.
  """
  ...
  @doc """
  Gets states of countries

  """
  def get_states_country(country_id) do
    #Repo.get_by(State, country_id: country_id)
    from(s in State, select: %{"id": s.id, "name": s.name }, where: s.country_id==^country_id and s.active==true) |> Repo.all
   end
